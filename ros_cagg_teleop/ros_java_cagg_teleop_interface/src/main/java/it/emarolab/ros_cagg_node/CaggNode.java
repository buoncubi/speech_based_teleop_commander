        ...
        subscriber.addMessageListener(message -> {
            ...
            synchronized (this) {
                for (String t : texts) {
                    ...
                    semanticTags.get( semanticTags.size() - 1).setComputationMillisecond( System.currentTimeMillis() - start);
                }
            }
        });
            ...
            protected void loop() throws InterruptedException {
                ...
                synchronized (this) {
                    ...
                    for( CaggInterface.ROSResult st : semanticTags){
                        ...
                        caggEvaluationMsg.setComputationTimeMs( st.getComputationMillisecond());
